...
def main():
    ...
    print(f"Loading trained RoBERTa model (artem9k) from: {model_path}")
    ...
    print("Starting predictions on the hyper-local OOD dataset...")
    ...
    print("\n" + "="*50)
    print("RESULTS: RoBERTa (artem9k) ON OOD DATA")
    print("="*50)
